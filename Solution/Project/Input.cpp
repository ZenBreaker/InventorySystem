...
{
  Item* item0 = new Item();
  Item* item1 = new Item("Scroll");
  Item* item2 = new Item("Health Pot");
  Item* item3 = new Item("Dagger", 1,3);
  ...
  Item* item4 = new Item("Iron Sword", 2, 3);
  printf("\nprinting item 4... (name, width, height) \n");
  item4->Print(PRINTROBUSTNESS::FULL_DESCRIPTION);
  Item* item5 = new Item("Scroll");
  printf("\nprinting item 5... (name) \n");
  item5->Print(PRINTROBUSTNESS::FULL_DESCRIPTION);
  Item* item6 = new Item("Gold Sword", 3, 3);
  printf("\nprinting item 6... (name, width, height) \n");
...
void InputAddGenericItem(Inventory& inventory)
{
  ...
  inventory.AddItem(new Item(name, width, height));
}
...
void InputRun()
{
  ...
  switch (input)
  {
    ...
    case 1:
    {
      printf("\nCurrently being reworked (WILL CRASH)\n");
